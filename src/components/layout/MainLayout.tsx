...
const routeAccess: { prefix: string; roles: UserRole[] }[] = [
  ...
  { prefix: '/financeiro', roles: ['master', 'project_manager', 'consultant'] },
    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background">
        ...
        <SidebarInset className="flex min-h-0 flex-1 flex-col bg-background">
          ...
          <main className={isOperationsArea ? 'flex-1 overflow-y-auto bg-background p-[7%]' : 'flex-1 overflow-y-auto bg-background px-4 py-6 sm:px-6 lg:px-8 lg:py-8'}>
            {isOperationsArea ? (
              children
            ) : (
